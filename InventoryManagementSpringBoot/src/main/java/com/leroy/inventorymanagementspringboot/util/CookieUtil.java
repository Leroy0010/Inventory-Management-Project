...
public class CookieUtil {
    ...
    public void createJwtCookie(HttpServletResponse response, String token, int maxAge) {
        ...
        response.addHeader("Set-Cookie", 
            String.format("%s=%s; Max-Age=%d; Path=%s; HttpOnly; Secure; SameSite=%s",
                jwtCookieName, token, maxAge, cookiePath, cookieSameSite));
    }
    ...
    public void createRefreshTokenCookie(HttpServletResponse response, String refreshToken, int maxAge) {
        ...
        response.addHeader("Set-Cookie", 
            String.format("%s=%s; Max-Age=%d; Path=%s; HttpOnly; Secure; SameSite=%s",
                refreshTokenCookieName, refreshToken, maxAge, cookiePath, cookieSameSite));
    }
