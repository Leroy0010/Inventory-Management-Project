...
public class StoreKeeperTopbarController implements NeedsMainController, HasNotificationCount {
    ...
    public void updateNotificationCount(int count) {
        ...
        Platform.runLater(() -> {
            if (notificationCountLabel != null) {
                ...
                System.err.println("notificationCountLabel is null in StaffTopbarController.");
            }
        });
    }
