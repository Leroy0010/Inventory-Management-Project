...
export function useInventorySummaryStats(
    data: InventorySummaryItemDto[] | undefined
) {
    return useQuery({
        queryKey: ['inventorySummaryStats', data],
        queryFn: () => {
...
export function useYearlyInventorySummaryReport(
    ...
    const mutation = useMutation({
        mutationFn: () =>
            InventorySummaryReportApi.generateYearlyReport(
                year,
                type,
                costFlowMethod
            ),
...
export function useYearRangeInventorySummaryReport(
    ...
    const mutation = useMutation({
        mutationFn: () =>
            InventorySummaryReportApi.generateYearRangeReport(
                startYear,
                endYear,
                type,
                costFlowMethod
...
export function useCustomDateRangeInventorySummaryReport(
    ...
    const mutation = useMutation({
        mutationFn: () =>
            InventorySummaryReportApi.generateCustomDateRangeReport(
                startDate,
                endDate,
                type,
                costFlowMethod
