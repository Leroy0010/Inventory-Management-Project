        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">
                  {isQuantityReport ? 'Brought Forward' : 'Value Brought Forward'}
                </p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">
                  {isQuantityReport ? 'Total Received' : 'Total Value Received'}
                </p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">
                  {isQuantityReport ? 'Total Issued' : 'Total Value Issued'}
                </p>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">
                  {isQuantityReport ? 'Net Change (Carried Forward)' : 'Net Value Change'}
                </p>
                <p className="text-lg font-semibold">
                  {isQuantityReport 
                    ? formatNumber(totalCarriedForward)
                    : formatCurrency(totalCarriedForward)
                  }
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              {getChangeIcon(totalBroughtForward, totalCarriedForward)}
              <span className={`text-sm font-medium ${getChangeColor(totalBroughtForward, totalCarriedForward)}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-semibold text-sm text-muted-foreground uppercase tracking-wide">
                {isQuantityReport ? 'Quantity Summary' : 'Value Summary'}
              </h4>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm">Brought Forward:</span>
                ...
                <div className="border-t pt-3">
                  <div className="flex justify-between items-center font-semibold">
                    ...
                    <span className={`font-mono ${getChangeColor(totalBroughtForward, totalCarriedForward)}`}>
                      {isQuantityReport 
                        ? formatNumber(totalCarriedForward)
                        : formatCurrency(totalCarriedForward)
                      }
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm">Net Movement:</span>
                  <span className={`font-mono text-sm ${getChangeColor(totalBroughtForward, totalCarriedForward)}`}>
                    {isQuantityReport 
