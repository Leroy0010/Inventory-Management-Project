...
import { useNotifications, useMarkAllAsRead } from '@/hooks/queries/useNotification';
...
const NOTIFICATION_TYPES: { value: NotificationType | 'ALL'; label: string }[] = [
  ...
  { value: NotificationType.REQUEST_APPROVED, label: 'Approved Requests' },
  { value: NotificationType.REQUEST_REJECTED, label: 'Rejected Requests' },
  { value: NotificationType.REQUEST_FULFILLED, label: 'Fulfilled Requests' },
...
export function NotificationList({ className = '' }: NotificationListProps) {
  ...
  const currentFilters: NotificationFilters = {
    ...
    isRead: readStatusFilter === 'all' ? undefined : readStatusFilter === 'unread' ? false : true,
  };
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                {searchTerm || typeFilter !== 'ALL' || readStatusFilter !== 'all' 
