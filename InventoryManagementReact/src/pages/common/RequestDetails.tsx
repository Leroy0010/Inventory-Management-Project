...
export default function RequestDetails() {
  ...
  useEffect(() => {
    ...
    const mockRequest: Request = {
      ...
      description: 'Request for essential office supplies for the finance department',
      requesterId: 'user-1',
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-destructive">Request Not Found</h2>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-4">
              ...
              {request.approverName && (
                <div>
                  ...
                  <p className="text-lg">{request.approverName}</p>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between text-lg font-semibold">
                  ...
                  <span>${request.totalValue.toFixed(2)}</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {/* Actions */}
          {hasPermission('APPROVE_REQUESTS') && request.status === 'PENDING' && (
            <Card>
              <CardHeader>
