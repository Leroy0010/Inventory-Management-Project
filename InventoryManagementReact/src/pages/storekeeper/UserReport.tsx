...
export default function UserReport() {
    ...
    const filteredUserActivities = userActivities.filter((activity) => {
        const matchesRole =
            filters.role === 'ALL' || activity.userRole === filters.role;
        ...
        return (
            matchesRole && matchesDepartment && matchesStatus && matchesSearch
        );
    });
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-blue-600">
                                        {summary.averageRequestsPerUser}
                                    </p>
                                </div>
                            </div>
                        </CardContent>
                            ...
                            {summary.topRequesters.map((requester, index) => (
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        <p className="font-medium">
                                            ${requester.totalValue.toFixed(2)}
                                        </p>
                                        <p className="text-sm text-muted-foreground">
                                            Total Value
                                        </p>
                            ...
                            {filteredUserActivities.map((activity) => (
                                <TableRow key={activity.id}>
                                    ...
                                    <TableCell>
                                        <span className="font-medium">
                                            $
                                            {activity.totalValueRequested.toFixed(
                                                2
                                            )}
                                        </span>
                                    </TableCell>
