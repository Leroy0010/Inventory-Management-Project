...
import {
    ...
    useInventorySummaryReportExport,
} from '@/hooks/queries/useInventorySummaryReport';
...
export default function InventorySummaryReport() {
    ...
    const [currentFilters, setCurrentFilters] =
        useState<InventorySummaryReportFilters | null>(null);
    ...
    const apiRequest = useMemo((): InventorySummaryReportRequest | null => {
        ...
        const { inventorySummaryType, costFlowMethod, officeId, dateRange } =
            currentFilters;
    ...
    const { data: stats, isLoading: statsLoading } =
        useInventorySummaryStats(reportData);
    ...
    const handleGenerateReport = async (
        filters: InventorySummaryReportFilters
    ) => {
        ...
        <div className="space-y-6">
            ...
            {lastGenerated && reportData.length > 0 && (
                <Alert>
                    ...
                    <AlertDescription>
                        Report generated successfully on{' '}
            ...
            {/* Empty State */}
            {!isGenerating && reportData.length === 0 && !generationError && (
                <InventorysummaryEmptyState />
            )}
        </div>
    );
}
