...
export default function InventorySummaryReport() {
  ...
  useEffect(() => {
    ...
    const mockStats: SummaryStats = {
      ...
      topCategories: [
        { category: 'Office Supplies', itemCount: 3, totalValue: 1906.25 },
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">You don't have permission to view inventory summary reports.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Inventory Summary Report</h1>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Avg Stock Level</p>
                  <p className="text-2xl font-bold text-blue-600">{stats.averageStockLevel}%</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell>
                    ...
                    <div className="text-xs text-muted-foreground mt-1">
                      {getStockLevelPercentage(item.currentStock, item.maxStock).toFixed(1)}%
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="text-sm">
                      <div>Restocked: {new Date(item.lastRestocked).toLocaleDateString()}</div>
                      <div className="text-muted-foreground">
                        Issued: {new Date(item.lastIssued).toLocaleDateString()}
                      </div>
                    </div>
                  </TableCell>
                </TableRow>
